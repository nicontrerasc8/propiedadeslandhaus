...
export const propiedades: Propiedad[] = [
  ...
  },
  {
    ...
    titulo: "Casa Aurora",
    descripcion:
      "Casa de concreto con vista espectacular, amplia terraza de madera y servicios completos dentro del condominio OxaChacos, a 8 km del centro de Oxapampa.",
    operacion: "Venta",
    tipo: "Casa",
    ubicacion: "Condominio OxaChacos, a 8 km del centro de Oxapampa",
    precio: "USD 250,000",
    areaConstruida: 148,
    areaTotal: 2271,
    dormitorios: 3,
    ...
    galeria: ["/c8/1.png"],
    fichaTecnica: [
      { label: "Area de terreno", value: "2,271 m2" },
      { label: "Area construida", value: "148 m2" },
      { label: "Precio", value: "USD 250,000" },
      { label: "Servicios", value: "Todos: luz con paneles (10 kw), agua, biodigestor e internet" },
      { label: "Documentos", value: "Partida electronica en RRPP, lista para transferir" },
      { label: "Ubicacion", value: "Condominio OxaChacos, a 8 km del centro de Oxapampa" },
      { label: "Ano de construccion", value: "2019" },
    ],
    distribucion: [
      {
        titulo: "Distribucion",
        items: ["3 habitaciones", "2 banos completos", "Lavanderia", "Amplia cocina"],
      },
    ],
    caracteristicasGenerales: [
      "La casa tiene una vista espectacular.",
      "La construccion es de concreto.",
      "Cuenta con techos Onduline.",
      "Tiene una amplia terraza de madera.",
    ],
  },
  {
    id: 8,
